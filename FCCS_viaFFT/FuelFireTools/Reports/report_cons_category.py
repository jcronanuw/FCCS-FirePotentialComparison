...
def add_header_content(elements):
    ...
    # Title
    ptext = '<font size={}>Consume 4.2 Consumption Report</font>'.format(const.FONTSIZE_TITLE)
...
def get_content(datafile):
    #Filename	Tree Crowns	Snag wood	Ladder	Shrub	Herb	Sound Wood	Rotten wood	Stumps	Piles	Litter	Lichen	Moss	Duff	BA	SM
